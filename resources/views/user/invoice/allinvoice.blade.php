            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 text-muted bg-white ">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 ">
                                <button type="button" class="text-white btn-theme ml-1 btn-block saveinvBtn" id="saveinvBtn">Save as .xlsx </button>
                                <button type="button" class="text-white btn-theme ml-1 btn-block savePdfBtn" id="savePdfBtn">Save as pdf </button>
                                <button type="button" class="text-white btn-theme ml-1 btn-block">Email as pdf </button>
                                ...
                                <table style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left;width: 108px;" class="">
                                                <input type="text"  name="totalvat" id="totalvat" class="form-control">
                                            </td>
                                        </tr>
                                        <tr>
